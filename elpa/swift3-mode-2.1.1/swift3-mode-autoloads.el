...

;;;### (autoloads nil "swift3-mode" "swift3-mode.el" (0 0 0 0))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "swift3-mode" '("swift3-mode")))

;;;***

;;;### (autoloads nil "swift3-mode-beginning-of-defun" "swift3-mode-beginning-of-defun.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from swift3-mode-beginning-of-defun.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "swift3-mode-beginning-of-defun" '("swift3-mode:")))

;;;***

;;;### (autoloads nil "swift3-mode-font-lock" "swift3-mode-font-lock.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from swift3-mode-font-lock.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "swift3-mode-font-lock" '("swift3-mode:f")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "swift3-mode-indent" '("siwft-mode:tokens-not-in-generic-parameter-list" "swift3-mode:")))

;;;***

;;;### (autoloads nil "swift3-mode-lexer" "swift3-mode-lexer.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from swift3-mode-lexer.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "swift3-mode-lexer" '("swift3-mode:")))

;;;***

;;;### (autoloads nil "swift3-mode-repl" "swift3-mode-repl.el" (0
;;;;;;  0 0 0))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "swift3-mode-repl" '("swift3-")))

;;;***

;;;### (autoloads nil nil ("swift3-mode-pkg.el") (0 0 0 0))
